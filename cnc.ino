...
float StepsPerMillimeterX = 63.0; //71.04;
float StepsPerMillimeterY = 94.0; //107.36;
...
void setup() {
    ...
    //  Notifications!!!
    Serial.println("Plotter CNC gotowy!");
    Serial.print("Przedzial X od ");
    Serial.print(Xmin);
    Serial.print(" do ");
    Serial.print(Xmax);
    Serial.println(" mm.");
    Serial.print("Przedzial Y od ");
    Serial.print(Ymin);
    Serial.print(" do ");
    Serial.print(Ymax);
    Serial.println(" mm.");
            ...
            if ((c == '\n') || (c == '\r')) {             // End of line reached
                ...
                if ((lineIsComment) || (lineSemiColon)) {   // Throw away all comment characters
                    ...
                    if (c <= ' ') {                           // Throw away whitepace and control characters
                        ...
                        Serial.println("ERROR - przepelnienie linii buffora");
                        lineIsComment = false;
                        lineSemiColon = false;
        ...
        switch (line[currentIndex++]) {              // Select command, if any
            ...
            case 'G':
                ...
                switch (atoi(buffer)) {                   // Select G command
                    ...
                    case 4: {
                        char *indexS = strchr(line + currentIndex, 'P');
                        int Spos = atoi(indexS + 1);
                        Serial.println("G4 P: " + Spos);
                        delay(Spos);
                        break;
                    }   
                }
            ...
            case 'M':
                ...
                switch (atoi(buffer)) {
                    case 17: {
                        Serial.print("Dolacz zasoby, M17: ");
                    ...
                    case 18: {
                        myStepperX.release();
                        myStepperY.release();
                        Serial.print("Zwolnij zasoby, M18: ");
                        Serial.println(buffer);
                        delay(500);
                    }
                    case 300: {
                        ...
                        if (Spos == 255) {
                            ...
                            Serial.println("Zwolnij servo, M300 S255 ");
                            Serial.println(buffer);
                        }
                        break;
                    }
                    case 114:                                // M114 - Repport position
                        Serial.print("Pozycja absolutna: X = ");
                        Serial.print(actuatorPos.x);
                        Serial.print("  -  Y = ");
                        Serial.println(actuatorPos.y);
                        break;
                    default:
                        Serial.print("Komenda nierozpoznana: M");
                        Serial.println(buffer);
                }
        }
    }
